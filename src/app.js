class IndecisionApp extends React.Component {
	...
	componentDidMount() {
		try {
			// get data from local storage set in componentDidUpdate
			const json = localStorage.getItem('options');
			const options = JSON.parse(json);

			// make sure options is not null/empty
			if (options) {
	...
	// end component life cycle methods
...
class AddOption extends React.Component {
	constructor(props) {
		...
		// refers to the handleAddOption that is called on form submit
		this.handleAddOption = this.handleAddOption.bind(this);
		this.state = {
			error: undefined
		};
